...
__all__ = ['preact_resnet20_cifar100', 'preact_resnet32_cifar100', 'preact_resnet44_cifar100', 
            'preact_resnet56_cifar100', 'preact_resnet110_cifar100']
...
class PreactResNetCifar(nn.Module):
    def __init__(self, block, layers, num_classes=NUM_CLASSES, conv_downsample=False, deeply_supervised=False, **kwargs):
        self.nlayers = 0
        ...
        # self.fc1 = self._make_deeply_supervised_layer(16 * block.expansion, num_classes)
        # self.fc2 = self._make_deeply_supervised_layer(32 * block.expansion, num_classes)

    def _make_deeply_supervised_layer(self, planes, num_classes):
        layers = [
