...
def get_parser():
    ...
    parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet18', type=lambda s: s.lower(),
                        ...
                        ' (default: resnet18)')
    parser.add_argument('--arch_dual', default='resnet18', type=lambda s: s.lower(),
                    choices=models.ALL_MODEL_NAMES,
                    help='model architecture: ' +
                    ' | '.join(models.ALL_MODEL_NAMES) +
                    ' (default: resnet18)')
    parser.add_argument('--dataset', default="cifar10", type=lambda s: s.lower(), choices=['cifar10', 'cifar100', 'imagenet'], help='dataset')
    ...
    parser.add_argument('--quan_resume', default='', type=str, metavar='PATH',
                        help='path to latest quantization checkpoint (default: none)')
    ...
    parser.add_argument('--pre_gate', action='store_true', default=False)

    parser.add_argument('--gate_channel', default=0, type=int, metavar='N')
    parser.add_argument('--alpha', default=0.1, type=float, 
                        help='Reward magnitude for the average number of skipped layers')
    parser.add_argument('--rl-weight', default=0.01, type=float, help='rl weight')
    parser.add_argument('--gamma', default=1, type=float, help='discount factor, default: (0.99)')
