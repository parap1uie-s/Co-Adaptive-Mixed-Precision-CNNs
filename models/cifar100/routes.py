...
class FeedforwardGateII(nn.Module):
    ...
    def __init__(self, pool_size=5, channel=10, gate_channel=10):
        ...
        if gate_channel != channel:
            self.reduce_dim = nn.Conv2d(channel, gate_channel, kernel_size=1, stride=1, bias=False)
